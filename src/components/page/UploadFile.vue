<template>
    <div class="file-style-box">
        <div class='upload-file-item'>
            <img :src="imgsrc[getEnd(file.name)]" alt="">
            <div>
                <p class='file-name'>
    ...
    data() {
        return {
            ...
            imgsrc: {
              ...
              */
                "rar": require('@/assets/logo.png'),
                "zip": require('@/assets/logo.png'),
                "pdf": require('@/assets/logo.png'),
                "jpg": require('@/assets/logo.png'),
                "jpeg": require('@/assets/logo.png'),
                "png": require('@/assets/logo.png'),
                "doc": require('@/assets/logo.png'),
                "docx": require('@/assets/logo.png'),
                "txt": require('@/assets/logo.png'),
                "xls": require('@/assets/logo.png'),
            }
        }
    },
    filters: {
