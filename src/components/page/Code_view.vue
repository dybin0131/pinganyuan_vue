                ...
                <el-card class="box-card" style='margin-top: 10px;height: 560px'>
                    ...
                    <div slot="header" class="clearfix" >
                        ...
                        <div style='display: flex;float: right;padding-top:0'>
                            ...
                            <el-button style='margin-left: 0'  @click="editInfo">
                                编辑
                            </el-button>
                            <el-button style='margin-left: 0'>原始数据</el-button>
                            <el-button style='margin-left: 0'>执行查看</el-button>
                            <el-button style='margin-left: 0'>历史</el-button>
