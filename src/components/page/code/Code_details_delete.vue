...
export default {
    ...
    data() {
        return {
            ...
            recentTrends: [
                { name: '韩梅梅', trends: '提交了文件router.c',time:'25天前' },
                { name: '韩梅梅', trends: '提交了文件navigation.c',time:'25天前' },
                { name: '李华', trends: '创建了仓库',time:'25天前' },
            ],
    ...
    methods: {
        ...
        applicationYes(){
            ...
            // 需要执行的代码
            setTimeout(this.myMessage, 10000); //1秒后開始运行 √
            // this. isCredible=60;
        },
        myMessage(){
            this.$message({
