<template>
    <div >
        ...
        <div style='position: relative;'>
            ...
            <div style='display: flex;margin-top: 20px'>
                ...
                <el-dropdown>
                    <div style='background-color: #CFE0FA;opacity: 0.8;border-radius: 5px;margin-right:3px;width: 100px;height: 30px;'>
                        <el-button type='text' style='margin-left: 18px;font-size: 15px'>
                            主分支<i class="el-icon-arrow-down el-icon--right"></i>
                        </el-button>
                ...
                <div style='margin-left: 15px;display: flex'>
                    ...
                    <div style='font-size: 18px;font-family: Source Han Sans CN;font-weight: 400;color: #353D61;opacity: 0.8;margin-top: 4px'> main.cpp </div>
                </div>
        ...
        <div style='background: rgba(255,255,255,0.8);border: 1px solid;border-image: linear-gradient(0deg, #FFFFFF, #FFFFFF) 1 1;
            ...
            <el-button type='primary' style='margin-left: 35px' @click="save"> 保存 </el-button>
            <el-button type='primary' @click="toWarehouse"> 返回 </el-button>
...
export default {
    ...
    methods: {
        ...
        toWarehouse(){
            this.$router.push(
                {path:'/codedetails8',query:{username:this.repo.owner,warehouseName: this.repo.warehouseName,introduce:this.repo.info,
                warehouseKeywords:this.repo.language,isOwner:this.repo.isOwner,isMember:this.repo.isMember,owner:this.repo.owner,
                isManager:this.repo.isManager,isCertificator:this.repo.isCertificator}}
            )
        },
